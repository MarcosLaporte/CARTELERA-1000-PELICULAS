...
let max = 1001;
let random;
let SEEN = [ , 1, 7, 8, 12, 19, 20, 21, 22, 24, 25, 28, 31, 35, 38, 54, 65, 69, 76, 80, 82, 92, 93, 103, 104, 111, 112, 129, 135, 151, 152, 157, 165, 167, 188, 190, 192, 208, 233, 241, 248, 273, 281, 282, 283, 284, 285, 289, 297, 303, 305, 310, 311, 319, 320, 323, 339, 358, 364, 383, 403,
404, 408, 409, 416, 435, 456, 462, 473, 487, 492, 508, 514, 517, 535, 545, 553, 555, 583, 587, 591, 601, 604, 607, 619, 630, 639, 671, 685, 688, 690, 695, 716, 717, 733, 735, 752, 756, 767, 772, 776, 780, 785, 787, 869, 876, 877, 882, 886, 897, 903, 919, 932, 937, 939, 945, 959, 994];
let BEST = [ , 5, 27, 73, 81, 185, 226, 246, 265, 414, 437, 465, 467, 533, 598, 745, 842, 954];
let BAD = [ , 106, 529, 530, 758];
let nameSEEN = [];
let nameBEST = [];
let nameBAD = [];
